		...
		<article id="post-<?php the_ID(); ?>" <?php post_class();?>>
			<header class="entry-header">
				...
				<div class="entry-meta">
					...
					<span class="author vcard"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="<?php the_title_attribute(); ?>"><i class="fa-solid fa-user"></i>
			...
			<header class="entry-header">
				...
				<?php 
					...
					<div class="entry-meta">
						...
						<?php if ( comments_open() ) { ?>
						<span class="comments">
						<?php comments_popup_link( __( '<i class="fa-solid fa-comment"></i>', 'pixgraphy' ), __( '<i class="fa-solid fa-comment"></i>', 'pixgraphy' ), __( '% <i class="fa-solid fa-comment"></i>', 'pixgraphy' ), '', __( 'Comments Off', 'pixgraphy' ) ); ?> </span>
						<?php } ?>
					</div> <!-- end .entry-meta -->
				<?php } ?>
